  ...
  return (
    ...
    <div className='grid bg-white rounded-t-lg sm:w-[38.5rem] shadow-2xl'>
      <article className='pr-9 pl-9 pb-8 pt-9 flex flex-col flex-wrap'>
        ...
        <p className=' text-neutral-Grayish-Blue pt-3 text-base font-karla sm:max-w-[34.56rem]'>Gain access to our full library of tutorials along with expert code reviews. Perfect for any developers who are serious about honing their skills.</p>
      </article>
    </div>
    <div className="grid grid-cols-1 sm:grid-cols-2 sm:w-[38.5rem] rounded-b-lg  shadow-2xl">
        <section className='flex flex-col sm:items-start sm:justify-start bg-primary-cyan sm:rounded-bl-lg pt-8 pl-9 pr-8'>
        ...
        <a href='/' className='mt-8 bg-primary-Bright-Yellow w-full py-3 rounded-md shadow-xl text-center hover:bg-[#cdee12] text-base text-white cursor-pointer mb-8'>Sign up</a>        
        </section>
      <section className='flex flex-col pt-8 pl-9 pb-2 pr-8 justify-start bg-[#41bbb9] rounded-b-lg sm:rounded-b-none sm:rounded-br-lg'>
        ...
        <p className='text-slate-300 font-karla pt-2 sm:max-w-[12.46rem] text-[0.99rem] pb-2'>Tutorials by industry experts Peer & expert code review Coding exercises Access to our GitHub repos Community forum Flashcard decks New videos every week</p>
      </section>
    </div>
  </main>  
  );
