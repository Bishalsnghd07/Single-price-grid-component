...
export default function Home() {
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 sm:w-[38.5rem] rounded-b-lg  shadow-2xl">
        <section className='flex flex-col sm:items-start sm:justify-start bg-[#018576] sm:rounded-bl-lg pt-8 pl-9 pr-7 pb-2'>
      ...
      <section className='flex flex-col pt-8 pl-9 pb-2 pr-8 justify-start bg-[#008564] rounded-b-lg sm:rounded-b-none sm:rounded-br-lg'>
        <h5 className='text-white font-medium font-karla'>
        Why us
        </h5>
        <p className='text-white font-karla pt-2 sm:max-w-[13.76rem] text-[0.99rem] mb-2 sm:mb-0'>Tutorials by industry experts Peer & expert code review Coding exercises Access to our GitHub repos Community forum Flashcard decks New videos every week</p>
      </section>
    </div>
  </main>  
  );
