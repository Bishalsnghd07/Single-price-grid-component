...
export default function Home() {
  return (
    <main className="min-h-screen justify-center items-center flex flex-col overflow-hidden bg-neutral-Light-Gray p-6">
      ...
      <section className="flex flex-col bg-[#018576] pt-10 pl-9 pr-7 pb-4 sm:rounded-bl-lg">
      ...
      <section className="bg-[#008564] pt-9 pl-8 pr-8 pb-6 rounded-b-lg sm:rounded-b-none sm:rounded-br-lg">
        ...
        <p className="text-white text-[0.94rem] font-karla pt-4 sm:max-w-[12rem]">Tutorials by industry experts Peer & expert code review Coding exercises Access to our GitHub repos Community forum Flashcard decks New videos every week</p>
      </section>
        </div>
    </main>
  );
