  ...
  return (
    <main className='flex flex-col min-h-screen p-4 justify-center items-center bg-neutral-Light-Gray overflow-hidden'>
      ...
      <article className='pt-8 pr-8 pl-9 pb-9 flex flex-col flex-wrap'>
        ...
        <h2 className='text-[#767601] text-em font-semibold text-base leading-7 pt-6'>30-day hassle-free money back guarantee</h2>
      ...
      <section className='flex flex-col sm:items-start sm:justify-start bg-[#018576] sm:rounded-bl-lg p-9'>
      ...
      <section className='flex flex-col justify-start bg-[#008564] rounded-b-lg sm:rounded-b-none sm:rounded-br-lg p-9'>
